...
function checkColor(color) {
    ...
    if (color != "default") {
        $(".flowList.for-cur").css({ "border": "2px solid #AAC5EE"});
        $(".flowList.for-cur,.flowListBox .for-cur em").css({ "background-color": "#AAC5EE"});
...
function loadFlowDiv(index){ 
 ...
 if(index==1){$("#contA").removeClass("registerList");$("#contA").siblings().addClass("registerList")}
 if(index==2){$("#contB").removeClass("registerList");$("#contB").siblings().addClass("registerList")}
 if(index==3){$("#contC").removeClass("registerList");$("#contC").siblings().addClass("registerList")}
 if(index==4){$("#contD").removeClass("registerList");$("#contD").siblings().addClass("registerList")}
